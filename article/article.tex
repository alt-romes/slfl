...
% While we were able to figure out a solution for the
% first couple of "infinite examples", the following problems were much harder,
% taking sometimes full days to solve.
...
To further showcase the expressiveness of our synthesizer, we present as
