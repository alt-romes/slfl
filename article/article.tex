...
focusing} is a technique to remove \emph{inessencial} non-determinism from
...
The core language is a simply typed linear lambda calculus for which the terms
($M,N$)
and types' ($\tau$) syntax is constructed with the following grammar:
\[
\begin{tabular}{lclc}
...
variables were assigned a type. These concepts
