...
We can force the usage of the recursive call by adding it not only to the
...
\and
    \mprset{flushleft}
    \infer*[right=(adtL)]
    { \Gamma ; \Delta/ \Delta'_1 ; \Omega, y_1{:}X_1 \Uparrow\ \vdash M_1 : C \and
    y_1 \not\in \Delta'_1
...
where the ADT \emph{Foo} and its definition stand for any ADT with form
\[
