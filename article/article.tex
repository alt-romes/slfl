...
variables $x$. For instance, the \dots \todo{Identity function!}
...
connectives.\todo{se mencionares intro e elim antes nao precisas de
  repetir aqui.}  The following rule captures the nature of a
