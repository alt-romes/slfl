...
recursive types, which is so undesirable that we add two rules to complement the
...
either instance the goal (provided they're the same type), fail if the
decomposition is restricted, or switch to inversion if it's not. The three
