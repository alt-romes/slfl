...
This comes from the close relation between logic and programming languages, called the Curry-Howard isomorphism or correspondence. A logical proof describes a program, and a program describes a proof.
The main observations made are ``propositions as types'', ``proofs as programs'', ``proof checking as type checking'' \cite{https://www.cs.cmu.edu/~fp/courses/15312-f04/handouts/23-curryhoward.pdf}.
...
This extended judgment, called a typing judgment has the form:
>>>>>>> fe3a3a5c662bd145ae6414f6993ee5441e6efc84
\[
    \Gamma \vdash M : A
\]
